...
const toolRegistry = {
  getSchoolOverview: {
    ...
    description: "Get a high-level statistical overview of the authenticated user's school.",
    parameters: { type: "object", properties: {} },
    handler: aiDataService.getSchoolOverview,
  },
  getAttendanceSummary: {
    name: "getAttendanceSummary",
    description: "Retrieve attendance statistics for the school, a class, or linked children.",
    parameters: {
      type: "object",
      properties: {
        className: { type: "string", description: "Optional class name" },
  ...
  getStudentAttendance: {
    ...
    description: "Retrieve date-by-date attendance records and statistics for an authorized student.",
    parameters: {
      type: "object",
      properties: {
        studentId: { type: "string", description: "Optional student ID" },
  ...
  getStudentResults: {
    ...
    description: "Retrieve the latest published academic and exam results for an authorized student.",
    parameters: {
      type: "object",
      properties: {
        studentId: { type: "string", description: "Optional student ID" },
        limit: { type: "integer", description: "Maximum latest results, from 1 to 25" },
      },
    },
  ...
  getFeeSummary: {
    name: "getFeeSummary",
    description: "Retrieve authoritative school-wide or student fee summary. Teachers are excluded.",
    parameters: {
      type: "object",
      properties: { studentId: { type: "string", description: "Optional student ID" } },
    },
