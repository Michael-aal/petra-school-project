...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'Exam') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'EmailLog') THEN
  ...
  IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'StudentAttendance') THEN
  ...
  IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'Attendance') AND EXISTS (SELECT 1 FROM pg_class WHERE relname = 'Student') AND EXISTS (SELECT 1 FROM pg_class WHERE relname = 'StudentAttendance') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'Exam') AND EXISTS (SELECT 1 FROM pg_class WHERE relname = 'Assessment') THEN
    INSERT INTO "Exam" (
