/*
  ...
  - You are about to drop the column `insuranceNumber` on the `StudentMedicalInfo` table. All the data in the column will be lost.
  - You are about to drop the column `insuranceProvider` on the `StudentMedicalInfo` table. All the data in the column will be lost.
  ...
  - Made the column `updatedAt` on table `Parent` required. This step will fail if there are existing NULL values in that column.
  ...
  - Made the column `updatedAt` on table `Teacher` required. This step will fail if there are existing NULL values in that column.
...
-- DropForeignKey
ALTER TABLE "TeacherClass" DROP CONSTRAINT "TeacherClass_schoolId_fkey";

-- DropForeignKey
ALTER TABLE "TeacherClass" DROP CONSTRAINT "TeacherClass_teacherId_fkey";

-- DropForeignKey
ALTER TABLE "TeacherSubject" DROP CONSTRAINT "TeacherSubject_schoolId_fkey";
...
-- DropIndex
DROP INDEX "User_selectedSchoolId_idx";
...
-- AlterTable
ALTER TABLE "StudentMedicalInfo" DROP COLUMN "insuranceNumber",
...
ADD COLUMN     "dailyTransactionLimit" DECIMAL(12,2),
ADD COLUMN     "defaultPaymentMethod" TEXT,
ADD COLUMN     "frozenBalance" DECIMAL(12,2) NOT NULL DEFAULT 0.00,
ADD COLUMN     "monthlyTransactionLimit" DECIMAL(12,2),
ADD COLUMN     "nickname" TEXT,
ADD COLUMN     "notes" TEXT,
ADD COLUMN     "notificationPreferences" JSONB,
ADD COLUMN     "parentUserId" TEXT,
ADD COLUMN     "spendingLimit" DECIMAL(12,2),
...
-- CreateIndex
CREATE INDEX "Grade_schoolId_subjectId_idx" ON "Grade"("schoolId", "subjectId");

-- CreateIndex
CREATE INDEX "Grade_schoolId_value_idx" ON "Grade"("schoolId", "value");

-- CreateIndex
CREATE INDEX "Grade_studentId_academicYearId_termId_idx" ON "Grade"("studentId", "academicYearId", "termId");
