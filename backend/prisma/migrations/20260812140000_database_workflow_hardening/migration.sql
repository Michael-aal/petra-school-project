...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'Exam') AND NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'ExamAttempt_examId_fkey') THEN
    ALTER TABLE "ExamAttempt" ADD CONSTRAINT "ExamAttempt_examId_fkey" FOREIGN KEY ("examId") REFERENCES "Exam"("id") ON DELETE CASCADE ON UPDATE CASCADE;
  END IF;
  IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'Student') AND NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'ExamAttempt_studentId_fkey') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'Exam') AND EXISTS (SELECT 1 FROM pg_class WHERE relname = 'ExamResult') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'ExamAttempt') AND EXISTS (SELECT 1 FROM pg_class WHERE relname = 'ExamResult') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'ClassMarkerIntegration') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'Expense') THEN
    IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'School') AND NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'Expense_schoolId_fkey') THEN
    ...
    END IF;
    IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'ExpenseCategory') AND NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'Expense_expenseCategoryId_fkey') THEN
    ...
    END IF;
    IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'AcademicYear') AND NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'Expense_academicYearId_fkey') THEN
    ...
    END IF;
    IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'Term') AND NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'Expense_termId_fkey') THEN
    ...
    END IF;
    IF EXISTS (SELECT 1 FROM pg_class WHERE relname = 'User') AND NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'Expense_createdById_fkey') THEN
