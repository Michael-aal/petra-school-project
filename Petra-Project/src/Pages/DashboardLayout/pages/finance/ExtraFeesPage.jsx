...
export default function ExtraFeesPage() {
  ...
  const editFee = (fee) => {
    ...
    setForm({
      ...
      quantityRequired: fee.quantityRequired === true,
      ...
      <section className="module-grid">
        <article className="module-card">
          ...
          <form className="fees-form" onSubmit={submit}>
            <input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="Fee name or category" required />
            ...
            <label className="fees-switch"><span>Quantity required?</span><select value={form.quantityRequired ? "yes" : "no"} onChange={(e) => setForm({ ...form, quantityRequired: e.target.value === "yes" })}><option value="no">No</option><option value="yes">Yes</option></select></label>
        ...
        <div className="module-grid">
          {fees.map((fee) => (
            <article key={fee.id} className="module-card fee-item">
              ...
              <p className="fee-quantity-status">Quantity: {fee.quantityRequired ? "Required" : "Not required"}</p>
              <div className="fees-actions">
