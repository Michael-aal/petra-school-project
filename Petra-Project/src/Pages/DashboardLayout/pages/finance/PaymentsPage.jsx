            ...
            <div className="modal-body">
              {activeModal.type === "view" && activeModal.payment ? (
                <div className="payments-details-grid">
                  ...
                  {activeModal.payment.paymentLines?.length ? (
                    <div className="payments-detail-row payments-detail-lines">
                      <span>Items</span>
                      <div>
                        {activeModal.payment.paymentLines.map((line) => (
                          <strong key={line.id}>
                            {line.feeName} x {line.quantity} ({formatCurrency(line.unitAmount)} each) = {formatCurrency(line.lineTotal)}
                          </strong>
                        ))}
                      </div>
                    </div>
