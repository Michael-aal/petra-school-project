  ...
  return (
    <article className="results-card">
      <div className="results-card-heading">
        <div>
          <p className="results-card-label">Student assessment result</p>
          <h2>{item.examTitle || "Untitled Exam"}</h2>
        </div>
      ...
      <div className="results-card-top">
        ...
        <div className="results-card-identity">
          <span>Student / admission code</span>
          <strong>{item.admissionCode || item.applicationCode || "Not available"}</strong>
        </div>
      </div>
      ...
      <div className="results-grid">
        <div>
          ...
          <strong>{formatDateTime(item.assessmentDate)}</strong>
        </div>
        <div>
          <span>Subject</span>
        ...
        <div>
          ...
          <strong>{item.source === "exam_result" || item.source === "legacy" ? "Published" : "Pending"}</strong>
        </div>
      </div>
    </article>
  );
