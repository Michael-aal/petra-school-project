...
const navGroups = [
  { label:"Nuvora", icon:UserRound, href:"/dashboard/ask-nuvora" }, { label:"Get Started", icon:Rocket, href:"/dashboard/get-started" }, { label:"Dashboard", icon:LayoutDashboard, href:"/dashboard" },
...
const staffNavGroups = [
  {label:"Nuvora",icon:UserRound,href:"/staff/ask-nuvora"},
