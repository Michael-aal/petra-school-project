...
const About = () => {
  return (
    <main className="nuvora-about">
      ...
      {/* =====================================================
          CTA (moved to bottom, but we keep it here as in your code)
      ===================================================== */}
      ...
      <section className="about-story section">
        <div className="container about-story__grid">
          ...
          <div className="about-story__content">
            <h2>
              We started with a payment problem.
              We found a much bigger one.
            </h2>
            ...
            <div className="story-copy">
              ...
              <p>
                ...
                But as we worked closer with schools, something
                became clear. Payments were only one part of the
                problem.
              </p>
          ...
          <div className="platform-list">
            ...
            <div className="platform-row">
              ...
              <div className="platform-row__main">
                ...
                <p>
                  ...
                  budgeting, and financial visibility built into a
            ...
            <div className="platform-row">
              ...
              <div className="platform-row__main">
                ...
                <p>
                  Attendance, results, assessments, CBT, academic
                  workflows, and the systems teachers use every day.
                </p>
              </div>
            ...
            <div className="platform-row">
              ...
              <div className="platform-row__main">
                ...
                <p>
                  AI and analytics that turn school data into useful
                  information for administrators, teachers, and
                  decision-makers.
                </p>
              </div>
        ...
        <div className="container about-evolution__grid">
          ...
          <div className="about-evolution__timeline">
            <div className="timeline-item">
              ...
              <div>
                ...
                <p>
                  Making school payments simpler and more
                  accessible.
                </p>
              </div>
            </div>
            ...
            <div className="timeline-item timeline-item--active">
              ...
              <div>
                ...
                <p>
                  Expanding from payments into the systems
                  schools depend on every day.
                </p>
              </div>
            </div>
          ...
          <div className="about-evolution__content">
            ...
            <p>
              ...
              payment processor. They needed a system that understood
              how their entire organization worked.
            </p>

            <p>
              Our approach is deliberately African. We design for
              mobile-first families, imperfect connectivity, local
              payment realities, and the operational complexity
        ...
        <div className="container">
          ...
          <div className="innovation-grid">
            ...
            <div className="innovation-item">
              ...
              <p>
                Transforming raw information into useful signals
          ...
          <div className="people-list">
            ...
            <div className="people-row">
              ...
              <div>
                ...
                <p>
                  Creating experiences schools and families actually
                  enjoy using.
                </p>
              </div>
            </div>
