  ...
  const dynamicSections = [
    {
      ...
      items: myChildren.map((child) => ({
        ...
        meta: [
          ...
          child.teacher || "Assigned Teacher",
        ]
          .filter(Boolean)
          .join(" • "),
    ...
    <Router>
      <Routes>
        ...
        <Route element={<DashboardLay />}>
          ...
          <Route
            path="/dashboard/overview/live"
            element={<LiveOverviewPage />}
          />
          <Route
            path="/dashboard/overview/daily"
            element={<DailyReportsPage />}
          />
          <Route
            path="/dashboard/overview/term"
            element={<TermSummaryPage />}
          />
          ...
          <Route
            path="/dashboard/students/applicants"
          ...
          <Route
            ...
            element={parentSection({
              ...
              heroDescription:
                "A healthy attendance record is visible right away for both children.",
              ...
              sections: [
                {
                  ...
                  items: [
                    {
                      title: "Ayo Ogunleye",
                      meta: "Present on 18 of 20 days",
                      value: "90%",
                    },
                    {
                      title: "Tolu Ogunleye",
                      meta: "Present on 17 of 20 days",
                      value: "85%",
                    },
                  ],
                },
              ...
              sections: [
                {
                  ...
                  items: [
                    {
                      title: "English",
                      meta: "Ayo improved in comprehension",
                      value: "81%",
                    },
                    {
                      title: "Science",
                      meta: "Tolu completed practicals",
                      value: "76%",
                    },
                  ],
                },
